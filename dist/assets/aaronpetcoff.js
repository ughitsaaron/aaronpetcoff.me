...
define('aaronpetcoff/routes/application', ['exports', 'ember'], function (exports, Ember) {
  ...
  exports['default'] = Ember['default'].Route.extend({
    title: function title(tokens) {
      var subtitle = 'aaron petcoff | web developer | brooklyn',
          title = tokens.length ? tokens.join(' | ') + ' | ' + subtitle : '' + subtitle;
...
define('aaronpetcoff/serializers/repository', ['exports', 'ember-data', 'ember'], function (exports, DS, Ember) {
      ...
      response.data = payload.items.map(function (repo) {
        ...
        */
        ...
        title = description[1],
            ...
            slides = undefined; // optional property in case slides aren't HTML
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        dom.setAttribute(el4,"href","/resume.pdf");
        dom.setAttribute(el4,"class","nav-link");
        dom.setAttribute(el4,"title","Resume");
        dom.setNamespace("http://www.w3.org/2000/svg");
        var el5 = dom.createElement("svg");
        dom.setAttribute(el5,"class","icon icon-profile");
        dom.setAttribute(el5,"viewBox","0 0 16 16");
        var el6 = dom.createElement("use");
        dom.setAttributeNS(el6,"http://www.w3.org/1999/xlink","xlink:href","#icon-profile");
        ...
        var el4 = dom.createElement("a");
        dom.setAttribute(el4,"class","footer-contact-link");
        dom.setAttribute(el4,"href","https://www.linkedin.com/in/aaronpetcoff");
        dom.setNamespace("http://www.w3.org/2000/svg");
        var el5 = dom.createElement("svg");
        dom.setAttribute(el5,"class","icon icon-linkedin");
        dom.setAttribute(el5,"viewBox","0 0 32 32");
        var el6 = dom.createElement("use");
        dom.setAttributeNS(el6,"http://www.w3.org/1999/xlink","xlink:href","#icon-linkedin");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        dom.appendChild(el2, el3);
      ...
      statements: [
        ...
        ["content","outlet",["loc",[null,[13,4],[13,16]]]],
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    var child1 = (function() {
      ...
      return {
        ...
        statements: [
          ["block","link-to",["blog.post",["get","model.slugs.prev",["loc",[null,[16,29],[16,45]]]]],["class","post-nav-previous"],0,null,["loc",[null,[16,6],[16,93]]]]
        ],
        locals: [],
        templates: [child0]
      };
    ...
    var child2 = (function() {
      ...
      return {
        ...
        statements: [
          ["block","link-to",["blog.post",["get","model.slugs.next",["loc",[null,[20,29],[20,45]]]]],["class","post-nav-next"],0,null,["loc",[null,[20,6],[20,85]]]]
        ],
        locals: [],
        templates: [child0]
      };
    ...
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        dom.setAttribute(el1,"itemscope","itemscope");
        dom.setAttribute(el1,"itemtype","http://schema.org/BlogPosting");
        var el2 = dom.createTextNode("\n  ");
        dom.appendChild(el1, el2);
        var el2 = dom.createElement("h1");
        dom.setAttribute(el2,"itemprop","name headline");
        var el3 = dom.createComment("");
        dom.appendChild(el2, el3);
        dom.appendChild(el1, el2);
        var el2 = dom.createTextNode("\n  ");
        ...
        dom.setAttribute(el2,"itemprop","datePublished");
        var el3 = dom.createComment("");
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode(" |");
        dom.appendChild(el2, el3);
        ...
        dom.appendChild(el1, el2);
        var el2 = dom.createElement("span");
        dom.setAttribute(el2,"class","post-tags");
        dom.setAttribute(el2,"itemprop","keywords");
        var el3 = dom.createTextNode("\n");
        dom.appendChild(el2, el3);
        var el3 = dom.createComment("");
        dom.appendChild(el2, el3);
        ...
        dom.setAttribute(el2,"class","post-body");
        dom.setAttribute(el2,"itemprop","text articleBody");
        var el3 = dom.createTextNode("\n    ");
        dom.appendChild(el2, el3);
        var el3 = dom.createComment("");
        dom.appendChild(el2, el3);
        ...
        dom.setAttribute(el2,"itemprop","pagination");
        var el3 = dom.createTextNode("\n");
        dom.appendChild(el2, el3);
        var el3 = dom.createComment("");
        dom.appendChild(el2, el3);
      ...
      buildRenderNodes: function buildRenderNodes(dom, fragment, contextualElement) {
        ...
        morphs[3] = dom.createUnsafeMorphAt(dom.childAt(element0, [7]),1,1);
      ...
      statements: [
        ["content","model.title",["loc",[null,[2,31],[2,46]]]],
        ["inline","moment-format",[["get","model.created",["loc",[null,[3,67],[3,80]]]],"YYYY.MM.DD"],[],["loc",[null,[3,51],[3,95]]]],
        ["block","each",[["get","model.tags",["loc",[null,[5,12],[5,22]]]]],[],0,null,["loc",[null,[5,4],[7,13]]]],
        ["content","model.body",["loc",[null,[11,4],[11,20]]]],
        ["block","if",[["get","model.slugs.prev",["loc",[null,[15,10],[15,26]]]]],[],1,null,["loc",[null,[15,4],[17,11]]]],
        ["block","if",[["get","model.slugs.next",["loc",[null,[19,10],[19,26]]]]],[],2,null,["loc",[null,[19,4],[21,11]]]],
        ["inline","disqus-comments",[],["identifier",["subexpr","@mut",[["get","model.title",["loc",[null,[24,31],[24,42]]]]],[],[]]],["loc",[null,[24,2],[24,44]]]]
      ],
      locals: [],
    ...
    var child0 = (function() {
      var child0 = (function() {
        return {
          ...
          statements: [
            ["content","post.title",["loc",[null,[3,109],[3,123]]]]
          ],
          locals: [],
          templates: []
        };
      ...
      return {
        ...
        buildFragment: function buildFragment(dom) {
          ...
          dom.setAttribute(el3,"itemprop","keywords");
          var el4 = dom.createTextNode("\n");
          dom.appendChild(el3, el4);
          var el4 = dom.createComment("");
          dom.appendChild(el3, el4);
        ...
        statements: [
          ["block","link-to",["blog.post",["get","post.slugs.self",["loc",[null,[3,75],[3,90]]]]],["title",["subexpr","@mut",[["get","post.title",["loc",[null,[3,97],[3,107]]]]],[],[]]],0,null,["loc",[null,[3,52],[3,135]]]],
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        var el3 = dom.createTextNode("\n  I'm an ambitious web developer who is passionate about learning new technologies, building community, and making the web (and the world) a better place.\n  ");
        dom.appendChild(el2, el3);
        dom.appendChild(el1, el2);
        var el2 = dom.createTextNode("\n\n  ");
        dom.appendChild(el1, el2);
        ...
        dom.appendChild(el3, el4);
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode(" where I help build rad open-source publishing systems.");
        dom.appendChild(el2, el3);
        dom.appendChild(el1, el2);
        var el2 = dom.createTextNode("\n  ");
        dom.appendChild(el1, el2);
        var el2 = dom.createElement("p");
        var el3 = dom.createTextNode("I live in Brooklyn. In my free time I enjoy reading history, sci-fi, and poetry, running in Prospect Park, and listening to records. I believe social, economic, and global justice are important. I write occasionally about what I do ");
        dom.appendChild(el2, el3);
        var el3 = dom.createComment("");
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode(".");
      ...
      statements: [
        ["block","link-to",["blog"],["title","Blog"],0,null,["loc",[null,[9,237],[9,291]]]]
      ],
      locals: [],
      templates: [child0]
    };
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    var child0 = (function() {
      return {
        ...
        statements: [
          ["attribute","href",["concat",[["get","talk.url",["loc",[null,[4,38],[4,46]]]],"/",["get","talk.slides",["loc",[null,[4,51],[4,62]]]]]]],
          ["attribute","title",["concat",[["get","talk.title",["loc",[null,[4,75],[4,85]]]]]]],
          ["content","talk.title",["loc",[null,[4,89],[4,103]]]],
...
define('aaronpetcoff/tests/adapters/repository.jshint', function () {
  ...
  QUnit.module('JSHint - adapters/repository.js');
  QUnit.test('should pass jshint', function(assert) {
    assert.expect(1);
...
define('aaronpetcoff/tests/components/not-found.jshint', function () {
  ...
  QUnit.module('JSHint - components/not-found.js');
  QUnit.test('should pass jshint', function(assert) {
    assert.expect(1);
...
define('aaronpetcoff/tests/components/post-list.jshint', function () {
  ...
  QUnit.module('JSHint - components/post-list.js');
  QUnit.test('should pass jshint', function(assert) {
    assert.expect(1);
...
define('aaronpetcoff/tests/integration/components/not-found-test.jshint', function () {
  ...
  QUnit.module('JSHint - integration/components/not-found-test.js');
  QUnit.test('should pass jshint', function(assert) {
    assert.expect(1);
...
define('aaronpetcoff/tests/routes/application.jshint', function () {
  ...
  QUnit.test('should pass jshint', function(assert) {
    assert.expect(1);
    assert.ok(false, 'routes/application.js should pass jshint.\nroutes/application.js: line 7, col 7, Bad line breaking before \'?\'.\n\n1 error');
  });
...
define('aaronpetcoff/tests/routes/blog/error.jshint', function () {
  ...
  QUnit.module('JSHint - routes/blog/error.js');
  QUnit.test('should pass jshint', function(assert) {
    assert.expect(1);
...
define('aaronpetcoff/tests/routes/blog/post.jshint', function () {
  ...
  QUnit.module('JSHint - routes/blog/post.js');
  QUnit.test('should pass jshint', function(assert) {
    assert.expect(1);
...
define('aaronpetcoff/tests/routes/blog/tags.jshint', function () {
  ...
  QUnit.module('JSHint - routes/blog/tags.js');
  QUnit.test('should pass jshint', function(assert) {
    assert.expect(1);
...
define('aaronpetcoff/tests/routes/four-oh-four.jshint', function () {
  ...
  QUnit.module('JSHint - routes/four-oh-four.js');
  QUnit.test('should pass jshint', function(assert) {
    assert.expect(1);
...
define('aaronpetcoff/tests/serializers/repository.jshint', function () {
  ...
  QUnit.module('JSHint - serializers/repository.js');
  QUnit.test('should pass jshint', function(assert) {
    assert.expect(1);
    assert.ok(true, 'serializers/repository.js should pass jshint.');
  });
...
define('aaronpetcoff/tests/unit/adapters/repository-test.jshint', function () {
  ...
  QUnit.module('JSHint - unit/adapters/repository-test.js');
  QUnit.test('should pass jshint', function(assert) {
    assert.expect(1);
...
define('aaronpetcoff/tests/unit/routes/blog/error-test.jshint', function () {
  ...
  QUnit.module('JSHint - unit/routes/blog/error-test.js');
  QUnit.test('should pass jshint', function(assert) {
    assert.expect(1);
...
define('aaronpetcoff/tests/unit/routes/blog/post-test.jshint', function () {
  ...
  QUnit.module('JSHint - unit/routes/blog/post-test.js');
  QUnit.test('should pass jshint', function(assert) {
    assert.expect(1);
...
define('aaronpetcoff/tests/unit/routes/blog/tags-test.jshint', function () {
  ...
  QUnit.module('JSHint - unit/routes/blog/tags-test.js');
  QUnit.test('should pass jshint', function(assert) {
    assert.expect(1);
...
define('aaronpetcoff/tests/unit/routes/four-oh-four-test.jshint', function () {
  ...
  QUnit.module('JSHint - unit/routes/four-oh-four-test.js');
  QUnit.test('should pass jshint', function(assert) {
    assert.expect(1);
...
define('aaronpetcoff/tests/unit/serializers/repository-test.jshint', function () {
  ...
  QUnit.module('JSHint - unit/serializers/repository-test.js');
  QUnit.test('should pass jshint', function(assert) {
    assert.expect(1);
...
if (runningTests) {
  ...
  require("aaronpetcoff/app")["default"].create({"name":"aaronpetcoff","version":"0.0.0+79f82dcd"});
}
